...
public class NewsArrayAdapter extends ArrayAdapter<Result> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //sectionName.setVisibility(View.INVISIBLE);
        ...
        ImageView thumbnail = mListView.findViewById(R.id.imageThumb);
        try {
            Picasso.with(mListView.getContext()).load(result.getFields().getThumbnail()).into(thumbnail);
